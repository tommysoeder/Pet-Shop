...
const handleSubmitAdopted=(event)=>{event.preventDefault();}
  ...
  return (
    ...
    <h2 className='AdoptaGatoh'>Formulario de adopcion para {/*gato.nombre*/}</h2>
    <form className='FormularioAdopcion' onSubmit={handleSubmitAdopted}>
      ...
      <input className='InputForm1' type="text" id="apellido" value={apellido} onChange={(e)=>setApellido(e.target.value)} required />
       ...
       <div className='CategoriaFormulario'>
        ...
        <div className='CategoriaFormulario'>
        <div className='PreguntaFormIZQ'>
        <label className='AdoptaGatoh' htmlFor="mascotaName">Nombre del Gato<span className='requiredSpan'>*</span>:</label>
        ...
        <div className='FormDesarrollar'>
          <label className='AdoptaGatoh' htmlFor="razonAdopcion">1. ¿por qué has decidido adoptar un gato y no comprarlo? </label>
        ...
        <div className='FormDesarrollar'>
          <label className='AdoptaGatoh' htmlFor="razonAdopcion">3. ¿Sabes qué gastos puede ocasionar un gato? Veterinario, alimentación, medicación, etc.</label>
          <textarea id='razonAdopcion' value={razonAdopcion} onChange={(e)=>setRazonAdopcion(e.target.value)}/>
        </div>
