...
const AdoptaGato = (/*props*/) => {
  ...
  const handleSubmitAdopted=(event)=>{event.preventDefault();}
    ...
    return (
      ...
      <h1>Adopta un Gato(Preguntas Rapidas)</h1>
      <h2>Formulario de adopcion para {/*gato.nombre*/}</h2>
      <form onSubmit={handleSubmitAdopted}>
        ...
        <input className='InputForm1' type="text" id="apellido" value={apellido} onChange={(e)=>setApellido(e.target.value)} required />
         ...
         <div className='CategoriaFormulario'>
          ...
          <div className='CategoriaFormulario'>
          <div className='PreguntaFormIZQ'>
          <label htmlFor="mascotaName">Nombre del gato<span className='requiredSpan'>*</span>:</label>
          ...
          <div className='FormDesarrollar'>
            <label htmlFor="razonAdopcion">1. ¿por qué has decidido adoptar un gato y no comprarlo? </label>
          ...
          <div className='FormDesarrollar'>
            <label htmlFor="razonAdopcion">3. ¿Sabes qué gastos puede ocasionar un gato? Veterinario, alimentación, medicación, etc.</label>
            <textarea id='razonAdopcion' value={razonAdopcion} onChange={(e)=>setRazonAdopcion(e.target.value)}/>
          </div>
