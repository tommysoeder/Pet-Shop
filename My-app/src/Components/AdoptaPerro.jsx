...
const handleSubmitAdopted=(event)=>{event.preventDefault();}
  ...
  return (
    ...
    <h1>Adopta un Perro(Preguntas Rapidas)</h1>
    <h2>Formulario de adopcion para {/*perro.nombre*/}</h2>
    <form onSubmit={handleSubmitAdopted}>

      <div className='CategoriaFormulario'>
        <div className='PreguntaFormIZQ'>
      <label htmlFor="nombre">Nombre<span className='requiredSpan'>*</span>:</label>
      ...
      <label htmlFor="apellido">Apellido<span className='requiredSpan'>*</span>:</label>
      <input className='InputForm1' type="text" id="apellido" value={apellido} onChange={(e)=>setApellido(e.target.value)} required />
       ...
       <div className='CategoriaFormulario'>
        <div className='PreguntaFormIZQ'>
        <label htmlFor="fechaNacimiento">Fecha de nacimiento<span className='requiredSpan'>*</span>:</label>
        ...
        <div className='PreguntaFormDER'>
        <label htmlFor="direccion">Direccion<span className='requiredSpan'>*</span>:</label>
        ...
        <div className='FormDesarrollar'>
          <label htmlFor="razonAdopcion">1. ¿por qué has decidido adoptar un perro y no comprarlo? </label>
          <textarea id='razonAdopcion' value={razonAdopcion} onChange={(e)=>setRazonAdopcion(e.target.value)}/>
        </div>

        
        <div className='FormDesarrollar'>
          <label htmlFor="AmigosAnimales">2. En la actualidad, ¿tienes animales con los que tenga que convivir el adoptado? ¿cuáles? Cuéntanos algo sobre ellos. </label>
          <textarea id='AmigosAnimales' value={AmigosAnimales} onChange={(e)=>setAmigosAnimales(e.target.value)}/>
        </div>

        
        <div className='FormDesarrollar'>
          <label htmlFor="razonAdopcion">3. ¿Sabes qué gastos puede ocasionar un perro? Veterinario, alimentación, medicación, etc.</label>
          <textarea id='razonAdopcion' value={razonAdopcion} onChange={(e)=>setRazonAdopcion(e.target.value)}/>
        </div>

        
        <div className='FormDesarrollar'>
          <label htmlFor="razonAdopcion">4. ¿Hay niños en la vivienda?</label>
          <textarea id='razonAdopcion' value={razonAdopcion} onChange={(e)=>setRazonAdopcion(e.target.value)}/>
        </div>

        
        <div className='FormDesarrollar'>
          <label htmlFor="razonAdopcion">5. ¿Qué lugar de la vivienda estará destinado al animal? ¿ estaría dentro o fuera de la casa? En caso de ser un chalet, ¿está convenientemente vallado para su seguridad? </label>
          <textarea id='razonAdopcion' value={razonAdopcion} onChange={(e)=>setRazonAdopcion(e.target.value)}/>
        </div>
