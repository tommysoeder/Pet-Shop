    ...
    <div className='Nav_Burger'>
      ...
      {isOpen && (
        <div className="burger-content">
          <Nav_Button link={<Link to="/" onClick={closeDropdown}>Inicio</Link>}/>
          <div className='adopta'><AdoptaResponsive button="Adopta" onClick={closeDropdown} /></div>
          <Nav_Button link={<Link to="/dona" onClick={closeDropdown}>Dona</Link>}/>
          <Nav_Button link={<Link to="/sobre-nosotros" onClick={closeDropdown}>Sobre Nosotros</Link>}/>
        </div>
      )}
    </div>
  )
